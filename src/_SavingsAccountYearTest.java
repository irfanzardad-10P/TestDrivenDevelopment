...
public class _SavingsAccountYearTest {
	...
	@Test
	public void multipleWitdrawalsInAYearAreTotaled(){
		SavingsAccountYear year = newAccount();
		year.withdraw(1000);
		year.withdraw(2000);
	...
	@Test
	public void capitalGainsTaxIncurredIncurred_NeedsToCoverCapitalGainsWithdrawn_AND_theAdditionalCapitalGainsWithdrawnToPayCapitalGainsTax() {
	SavingsAccountYear year = new SavingsAccountYear(10000, 3000, 10);
	year.withdraw(5000);
	...
	int expectedStartingBalanceAfterWithdrawn = 10000 - amountWithdrawn - expectedCapitalGainsTax;
	assertEquals((int) (expectedStartingBalanceAfterWithdrawn * 1.10), year.endingBalance(25));
	}
